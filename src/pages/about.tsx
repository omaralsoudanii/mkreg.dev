        ...
        <div className="flex flex-col items-start space-y-12">
          <div className="flex flex-col space-y-4">
            ...
            <h3 className="font-extrabold text-tertiary">
              What technologies and programming languages you consider your self
              good at?
            </h3>
            <p className="text-lg">
            ...
            <p className="text-lg">
              ...
              during the life cycle of developing a software, whether it's about
            ...
            <p className="text-lg">
              In summary the technology you are gonna use is a tool to solve the
          ...
          <div className="flex flex-col space-y-4">
            ...
            <p className="text-lg">
              Well, let's just accept the fact that my Frontend skills is kinda
              worse than NVIDIA drivers support for linux. On a serious note, I
              simply don't have the talent for UI/UX, neither the experience on
              how to create eye pleasing applications. However I have a lot of
              knowledge in the Frontend engineering parts.
            </p>
          </div>
          <div className="flex flex-col space-y-4">
            <h3 className="font-extrabold text-tertiary">

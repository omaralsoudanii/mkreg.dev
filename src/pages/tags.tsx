...
export default function Tags({ tagCount, tags }) {
  ...
  return (
    <article>
      <Seo data={meta} />
      <section className="flex flex-col items-start justify-start divide-y-4 divide-gray-400 dark:divide-gray-700 md:justify-center md:items-center md:divide-y-0 md:flex-row md:space-x-6 md:mt-16">

            ...
            <div className="flex flex-col space-y-8 md:items-justify">
              <div className="flex flex-col space-y-4 md:items-start md:text-justify">
                ...
                <ul className="space-y-2 list-disc">
                  <li className="mx-8">
                    <p className="text-xl">
                      Code snippets: sharing some random code modules that I
                      reuse in my projects, probably Backend/Infra stuff.
                    </p>
                  </li>
                  <li className="mx-8">
                    <p className="text-xl">
                      Projects: open source side projects I made for fun. You
                      can treat them as boilerplate code, pick whatever you want
                      and integrate it in your code.
                    </p>
                  </li>
                  <li className="mx-8">
                    <p className="text-xl">

      ...
      <Container>
        <section>
          <div className="!mb-10 md:!mb-24">
            <h1 className="!font-semibold">Omar Alsoudani</h1>
            <h2 className="sub-heading">Software Engineer</h2>
            <h2 className="sub-heading">Architect</h2>
            <h2 className="sub-heading">Creator</h2>
          </div>

          <div className="flex flex-col md:!mb-24 !mb-10 items-start justify-start divide-y-2 divide-gray-700 dark:divide-gray-400 md:justify-center md:items-center md:divide-y-0 md:flex-row md:space-x-6 md:mt-16">

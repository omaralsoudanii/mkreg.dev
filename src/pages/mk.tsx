...
export default function MK() {
  ...
  return (
    <SectionContainer>
      <Seo data={meta} />
      <ProseLayout>
        <h1 className="lg:!mb-16 lg:mt-8 text-center block !text-4xl text-primary xl:!text-8xl">
          The Sultan of swing
        </h1>
        <div className="!space-y-4 lg:!space-y-8">
          ...
          <h1 className="text-center block !text-4xl text-primary font-black xl:!text-8xl">
            Mark Knopfler
          </h1>
          <p>
          ...
          <p>
            ...
            everyone has his own <strong>"Red Electric Guitar"</strong> in one
            way or another.
          </p>
          <p>
          ...
          <p>
            ...
            <strong>Hugo static sites generator</strong>, open-sourced and

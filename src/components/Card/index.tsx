...
const Card = ({ title, url, icon, desc }) => (
  <a key={title} href={url} target="_blank" rel="noopener noreferrer">
    <div className="flex items-center p-4 my-8 border border-gray-300 rounded lg:py-4 lg:px-8 dark:border-opacity-40 dark:border-gray-700">
      ...
      <div>
        ...
        <p className="!my-1  !text-secondary text-[0.9rem] lg:text-base !leading-snug !font-normal clamp clamp-5">
          {desc}
        </p>
      </div>
    </div>

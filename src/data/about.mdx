...
The knowledge from learning new programming languages and frameworks became less and less valuable to me over time – of course, programming languages with another paradigm is always beneficial (**Functional** & **Imperative**) – even if I don't use it directly it's gonna broaden my problem-solving capabilities with new ideas and possibly a different approach.

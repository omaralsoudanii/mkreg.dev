...
3. Everything that NGINX does in general to reduce the load on your software – usually the case when you have a web server not optimized to deal with things like SSL or request buffering – so adding NGINX will give you a free boost

...
1.  [Why do I need this?](#why-do-i-need-this)
...
The first 4 directives needs a lot of research before you apply them, however I use NGINX on this site.

I kept NGINX configuration on a separate branch—for those 4 directive you can read my [configuration file](https://github.com/omaralsoudanii/mkreg.dev/blob/main/docker/nginx/conf/nginx.conf) which has a brief documentation about them—for compression there is also a [configuration file](https://github.com/omaralsoudanii/mkreg.dev/blob/main/docker/nginx/conf/compression.conf) documented.

...
- [Docker](https://www.docker.com/) 
  ...
  You kinda hate Docker but you want the benefits, you know? when something is useful but it does have the habit of being a weirdo and log some errors unrelated to anything and your blood pressure starts rising up. 

  Or one of my favorites: I declare that this image layer is not in the **build cache**, I am going to rebuild the whole thing now. Please have a seat till rebuilding the whole Internet is finished so you can test your app.
...
- [Cloudflare](https://cloudflare.com/) 
  ...
  Takes care of delivering 99.9% of the app for a specified period of time that i can set. In fact it does so much stuff, to the degree that i believe their free plan is a steal. Kudos Cloudflare for having this amazing service. 
...
- [MDX](https://mdxjs.com/) 
  ...
  Since we're building a minimal app and not over engineering stuff 👆, MDX seemed like a good choice here (don't believe what I ever say, I didn't even know what MDX was).

- [Tailwindcss](https://tailwindcss.com/) 

  I saw this [guy](https://www.youtube.com/channel/UCy1H38XrN7hi7wHSClfXPqQ) just adding class names to stuff and every thing worked perfectly so I knew it would be a perfect fit Sadly I'm not that guy so I suffered trying to.... uhmm, you know the CSS stuff where you put font-size and hope it works on mobile too, and why the hell this **H1** is BIGGER than everything???

- [Vercel](https://vercel.com/) 

  Used as a staging server. It's perfect since you know Vercel will always output the correct result
  whether it's about what's rendered, caching or performance. Also it's nice to mimic their approach, good learning experience. 
...
This site used a lot of things from these resources, sometimes copy pasta of some component design or just some helpers code snippets, or simply by looking at the way things are handled. In the end the app deviated from those due to the rapid learning curve I gained while developing.

...
HAProxy is not just a **"Load Balancer"**. It's the perfect combo with Cloudflare.
...
If most of the site is served by Cloudflare and the revalidation is handled by HAProxy which is faster in this case because I'm only concerned about [L4](https://en.wikipedia.org/wiki/OSI_model) which HAProxy is miles ahead in this area compared to NGINX. Can't even dispute that. And this is coming from someone who puts NGINX on his top 3 favorite software.

### Docker

You kinda hate Docker but you want the benefits, you know? when something is useful but it does have the habit of being a weirdo and log some errors unrelated to anything raising your blood pressure. 

Or one of my favorites: 

I declare that this image layer is not in the **build cache**, I am going to rebuild the whole thing now. Please have a seat till rebuilding every image included in your build is done, then you can launch your **Dockerized app**!

...
image: '/static/images/writing/linux-commands/linux-bash-mysql-mkreg.jpg'
---

<Image 
  src="/static/images/writing/linux-commands/linux-bash-mysql-mkreg.jpg" 
  alt="Omar Alsoudani - Linux MySQL" 
  width={1920} 
  height={1080} 
/>
